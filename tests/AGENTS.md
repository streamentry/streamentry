...
- `test_external_release_gates.py`: protocol-fingerprint, status, gate-specific evidence-role, exact digest-field binding, path-reuse, and permitted-claim regressions for the external release packet.
