...
- `book/chapters/12-ban-do-tue.typ`: later-reference insight map. Define the map before taxonomy; keep the six-question explanation (foundation, changed knowing, possible experience, practice, insufficient lookalikes, transition) consistent across stages 1–11; never turn it into a beginner self-diagnostic ladder or stage-production recipe.
