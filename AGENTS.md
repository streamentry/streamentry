...
- `book/chapters/12-ban-do-tue.typ`: later-reference insight map. Define the map before taxonomy, separate object/knowing/reaction/conclusion, and preserve the direct beginner route to the four-region explanation. Keep the six-question explanation (foundation, changed knowing, possible experience, practice, insufficient lookalikes, transition) consistent across stages 1–11; never turn its ordinary-sitting loop into a self-diagnostic ladder or stage-production recipe.
