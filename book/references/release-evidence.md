...
| PDF SHA-256 | `7d30d7864b993f45118e92d2bbb1f10851d89c43aa2b84893260569fb72829c6` |
| EPUB SHA-256 | `1004a5505538d6ca29d4b4af044e085bdf24d9ba1b671f142122d294fc7e52c5` |
| PDF extent | 164 A5 pages |
| PDF file size | 1,353,213 bytes |
| EPUB navigation | 162 nested content entries plus 1 cover entry |
| EPUB archive size | 172,561 bytes |
...
| PDF metadata and tagging | Pass | `pdfinfo` reports Vietnamese title metadata, canonical author, tagged structure, 164 unrotated A5 pages, no encryption, no JavaScript, and no suspects; embedded text extraction preserves the safe first-sit anchor, canonical restart route, action-first feeling-to-craving drill, immediate safety shortcut, the object/basis/means explanation of the first three fetters, the not-self/identity-view bridge and exact Pāli formula, the meditation case, the 3–5–4 map, and the expanded insight-map foundations, region transitions, practice tasks, and evidential limits. |
| PDF visual QA | Pass internally | All 164 pages were inspected in nine contact sheets. Full-size checks covered the rewritten Chapter 12 pages 107–128, including the maturation criteria, route into the map, all four region profiles, repeated source badges, safety cautions, knee-pain comparison, and final reporting checklist; they found no collision, clipping, orphaned source label, or unusable whitespace. Earlier full-size checks covered Chapter 11 pages 94–98, the Chapter 10 opening model and meditation case, the frontmatter route, first-sit safety boxes, restart card, feeling-to-craving exercise, safety shortcut, and appendix lookup. The final render has no clipping, overlap, truncated badges, accidental blanks, duplicate glossary entry, missing glyphs, or broken hierarchy. |
