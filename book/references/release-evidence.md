...
| PDF SHA-256 | `fc965c5340f8535bfc01424a13e1a0abd12949c0f41283b58ff91f73caa3ccb5` |
| EPUB SHA-256 | `27f8a85df4b608d9d8c72fceda2413d23beaa7fb2e99da917fe9ca453aaa7d7f` |
| PDF extent | 219 A5 pages |
| PDF file size | 1,720,655 bytes |
| EPUB navigation | 251 nested content entries plus 1 cover entry |
| EPUB archive size | 246,948 bytes |
...
| Deterministic creation timestamp | `1787270400`, rendered as `2026-08-21T00:00:00Z` |
...
| EPUBCheck 5.3.0 | Not rerun for this candidate | The pinned validator runs in publication CI; no local run has been made against these exact EPUB bytes. The prior candidate's clean result is not transferred to this artefact. |
...
| PDF metadata and tagging | Pass | `pdfinfo` reports Vietnamese title metadata, the canonical credit, tagged structure, 218 unrotated A5 pages, no encryption, no JavaScript, and no suspects. Embedded text extraction preserves the first-sit and restart routes, source-code legend, source and safety boundaries, the three-level safety map, the first-three/five-lower/four-fruit distinctions, Chapter 10's canonical “who can attain?” cases, Chapter 12's beginner-first insight model with the four-region summary line, Chapter 13's four-task retrieval map, Chapter 7's pocket card and micro-practices, Appendix E's decision map, and the closing editorial-policy links. |
| PDF visual QA | Not rerun for this revised candidate | The prior candidate's pages 1 and 3 were rendered at 150 ppi and inspected full-size with no defect found, but that inspection predates the current content revision and is not transferred to these exact bytes. A fresh render-and-inspect pass remains required before print. |
