...
| PDF SHA-256 | `9251aa7a7206df57e33c7eaa0668f3556eec3da81b38b71bd76044887268f98f` |
| EPUB SHA-256 | `614a26a3afcf1354aa1429f43b165ead07f4e5dbead8f0fb29b0d29ca5a5ac9b` |
| PDF extent | 197 A5 pages |
| PDF file size | 1,661,210 bytes |
| EPUB navigation | 204 nested content entries plus 1 cover entry |
| EPUB archive size | 202,152 bytes |
...
| Builder structural checks | Pass | Strict edition schema, XML, manifest, resources, contract-derived language and labels, accessibility metadata, navigation, every content-link label, all 212 local-fragment links, all 60 absolute HTTPS external links, distinct labels for different external destinations, all 239 repeated-card visible-title bindings, bounded `note`/`group` roles, manuscript hash, required content, ZIP order, timestamp, and uncompressed mimetype. |
