...
| Item | Evidence |
|---|---|
| Edition contract SHA-256 | `955a07c423ec60ce78fc05ce3b2ed8a9fb2010e983fe273af46f4239f3eacb7f` |
| Immutable source SHA-256 | `ad7a886895cf8cd29b369fda89de5665c96907d990f95dba8f028336bcbbd440` |
| PDF SHA-256 | `20792263d5a5d7043b9f85fddc2c94280400338f89db974cc5211cab3b87b9d8` |
| EPUB SHA-256 | `1ef7c99949fa562fa1dac3322c0d9e0ad096bc587d4ea58b920f1afb2ca289af` |
| PDF extent | 173 A5 pages |
| PDF file size | 1,435,078 bytes |
| EPUB navigation | 175 nested content entries plus 1 cover entry |
| EPUB archive size | 180,110 bytes |
...
| PDF metadata and tagging | Pass | `pdfinfo` reports Vietnamese title metadata, canonical author, tagged structure, 173 unrotated A5 pages, no encryption, no JavaScript, and no suspects; embedded text extraction preserves the safe first-sit anchor, canonical restart route, Chapter 5's stay–switch–act decision, complete noting loop and explicit P01 pain-instruction conflict, the action-first feeling-to-craving drill, Chapter 7's three attention modes, collision loop, immediate-protection rule and post-error repair loop, the immediate safety shortcut, the object/basis/means explanation of the first three fetters, the not-self/identity-view bridge and exact Pāli formula, the meditation case, the 3–5–4 map, the expanded insight-map foundations, and Appendix E's four-node decision map. |
| PDF visual QA | Pass internally | All 173 pages were inspected in nine contact sheets. Full-size checks covered the new one-page Appendix E map on PDF page 164, including the safety gate, balanced formal-practice and daily-life branches, arrows, post-practice decision and source boundary. Earlier full-size checks covered Chapter 7 pages 54–61, Chapter 5 pages 40–48, the rewritten Chapter 12 pages 115–136, Chapter 11 pages 102–106, the Chapter 10 opening model and meditation case, the frontmatter route, first-sit safety boxes, restart card, feeling-to-craving exercise, safety shortcut, and appendix lookup. The final render has no clipping, overlap, truncated badges, accidental blanks, duplicate glossary entry, missing glyphs, or broken hierarchy. |
