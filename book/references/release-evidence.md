...
| PDF SHA-256 | `1997b740cd40d051816ca914db61f86c23f1c8bad2d756146734a720ed625032` |
| EPUB SHA-256 | `9c48df239c8bf232559e96c50482bcedaeb669d240e3b897cf3062b3f2e1f7f6` |
| PDF extent | 230 A5 pages |
| PDF file size | 1,722,907 bytes |
| EPUB navigation | 250 nested content entries plus 1 cover entry |
| EPUB archive size | 243,113 bytes |
...
| PDF metadata and tagging | Pass | `pdfinfo` reports Vietnamese title metadata, the canonical credit, tagged structure, 230 unrotated A5 pages, no encryption, no JavaScript, and no suspects. Embedded text extraction preserves the first-sit and restart routes, source-code legend, source and safety boundaries, the three-level safety map, the first-three/five-lower/four-fruit distinctions, Chapter 10's canonical “who can attain?” cases, Chapter 12's beginner-first insight model with the four-region summary line, Chapter 13's four-task retrieval map, Chapter 7's pocket card and micro-practices, Appendix E's decision map, and the closing editorial-policy links. |
| PDF visual QA | Pass internally | Pages 1, 17-18, 149-156, and 229-230 were rendered at 160 ppi and inspected full-size against the revised candidate. The cover credit is balanced; the complete four-decision block now begins on its own page; the compressed Chapter 12 opening keeps its hierarchy and reading rhythm; and the correction page remains legible. No clipping, overlap, broken frame, unreadable glyph, or unintended orphaned decision item was found. This targeted pass does not substitute for an external print proof or assistive-technology test. |
