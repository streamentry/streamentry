...
| PDF SHA-256 | `410554fbb18cb73446aaf109327df0ac3ae196e69b7bbe6450861f6bde3809d5` |
| EPUB SHA-256 | `42069a3d386332ed5707349c0a1e636776a69db37b28245802d6dbff1cc00dfc` |
| PDF extent | 155 A5 pages |
| PDF file size | 1,270,314 bytes |
| EPUB navigation | 156 nested content entries plus 1 cover entry |
| EPUB archive size | 164,953 bytes |
...
| PDF metadata and tagging | Pass | `pdfinfo` reports Vietnamese title metadata, canonical author, tagged structure, 155 unrotated A5 pages, no encryption, no JavaScript, and no suspects; embedded text extraction preserves the safe first-sit anchor, canonical restart route, action-first feeling-to-craving drill, immediate safety shortcut, the object/basis/means explanation of the first three fetters, the not-self/identity-view bridge and exact Pāli formula, the meditation case, the 3–5–4 map, and optional insight-map handoff. |
| PDF visual QA | Pass internally | All 155 pages were inspected in eight contact sheets. Full-size checks covered Chapter 11 pages 94–98, including the new not-self reasoning, Pāli/Vietnamese source boundary, bounded answer, and the revised 3+2 card split; they found no collision, clipping, orphaned source label, or unusable whitespace. Earlier full-size checks covered the Chapter 10 opening model, root-versus-manifestation distinction, knee-pain meditation case, and revised four-fruit map, in addition to the frontmatter route, first-sit safety boxes, days 8–30 bridge, restart card, action-first feeling-to-craving exercise, immediate safety shortcut, and appendix lookup. The final render has no clipping, overlap, truncated badges, accidental blanks, duplicate glossary entry, missing glyphs, or broken hierarchy. |
...
| Source-integrity re-audit | Pass internally | Every used K01–K40, P01–P02, V01, and R01–R09 code resolves in the source map. The load-bearing Chapter 10–11 claims were checked at segment level against Pāli roots and English translations frozen at SuttaCentral `bilara-data` commit `3af91efb1099190c74998247177f8ba6a076b8c0`. The new bridge separately binds MN 44:7.1–8.8, SN 22.59:2.1–10.1, and MN 2:11.1–11.4; it labels the incompatibility inference, identifies Dhammadinnā as the MN 44 speaker, and marks the Vietnamese SN 22.59 line as the book's literal rendering of the frozen Pāli. No contradiction was found, and every editorial synthesis or evidential limit remains labeled. Independent internal passes on onboarding friction, habit re-entry, pacing, prose, and acute-risk wording found no remaining material defect after corrections. These are internal reviews, not a named external Theravāda or clinical-safety sign-off. |
