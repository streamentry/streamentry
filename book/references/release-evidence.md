...
| PDF SHA-256 | `43387804f399b227cd6afe2f7870762aecc0252b2c7974d30ffb1a19a2400479` |
| EPUB SHA-256 | `b9beb4ebdaaee42fae7fddd330edd5c8d0553ca52c47beda524328ddc8e00059` |
| PDF extent | 182 A5 pages |
| PDF file size | 1,519,644 bytes |
| EPUB navigation | 179 nested content entries plus 1 cover entry |
| EPUB archive size | 187,916 bytes |
...
| PDF metadata and tagging | Pass | `pdfinfo` reports Vietnamese title metadata, canonical author, tagged structure, 182 unrotated A5 pages, no encryption, no JavaScript, and no suspects; embedded text extraction preserves the safe first-sit anchor, canonical restart route, Chapter 5's stay–switch–act decision, complete noting loop and explicit P01 pain-instruction conflict, the action-first feeling-to-craving drill, Chapter 7's three attention modes, collision loop, immediate-protection rule and post-error repair loop, the Vietnam 112–115 route, the object/basis/means explanation of the first three fetters, the not-self/identity-view bridge and exact Pāli formula, the meditation case, the 3–5–4 map, Chapter 12's object/knowing/reaction/conclusion split, seven-question orientation, ordinary-sitting loop, six-question stage explanation and stages 1–11, and Appendix E's safety-first decision map. |
| PDF visual QA | Pass internally | The unchanged 179-page baseline had previously been inspected in nine contact sheets. For this 182-page candidate, the complete changed Chapter 12 span at PDF pages 116–145 was rendered at 120 ppi and inspected in a 30-page contact sheet. Full-size composite checks covered the opener and new four-layer explanation on pages 116–117, the conclusion levels and reading route on pages 118–119, the seven-question orientation and direct taxonomy bypass on pages 120–121, the ordinary-sitting loop and start of the four-region explanation on pages 126–127, and representative dense late-stage and synthesis pages 138–141. The final cognitive-load edits were separately rendered at 144 ppi with adjacent context: Chapter 6 pages 51–52, Chapter 9 pages 67 and 69, Chapter 10 page 89, and Chapter 12 pages 118–119. No changed page showed clipping, overlap, truncated badges, accidental blank space, missing glyphs or broken hierarchy. Unchanged earlier full-size checks remain applicable to Chapter 7 pages 54–61, Chapter 5 pages 40–48, Chapter 11 pages 102–106, the Chapter 10 opening model and meditation case, the frontmatter route, first-sit safety boxes, restart card, feeling-to-craving exercise, safety shortcut, and appendix lookup. |
