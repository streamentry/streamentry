...
8. The insight map is not described as a numbered list spoken by the Buddha; its object/knowing/reaction/conclusion split, six-question reading frame, novice FAQ and ordinary-sitting loop are kept editorial; P02's phenomenology is not turned into a symptom checklist; and no fixed schedule or deliberate stage-producing exercise is inferred.
