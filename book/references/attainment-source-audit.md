...
four-pairs/eight-persons formula, the value assigned to Stream-entry in
Dhammapada 178, and the wider use of “fruits of the ascetic life” in DN 2. It
is designed to let a reviewer test the book at passage level without first
reconstructing the claim map.
...
| How strongly does the canonical verse value Stream-entry? | [Dhammapada 178 Pāli](https://suttacentral.net/dhp167-178/pli/ms); [Buddhist Publication Society edition](https://www.bps.lk/olib/bp/bp203s_Buddharakkhita_Dhammapada.pdf), verse 178 | Direct | **PASS WITH ATTRIBUTION BOUNDARY.** The verse says the fruit of Stream-entry is better than sole rule over the earth, going to heaven, and lordship over all worlds. Chapter 10 translates the Pāli closely and identifies its wording as the book's translation. | The verse ranks the fruit's value. It does not promise attainment, prescribe a method, or validate an experience. The Dhammapada is canonically received as sayings of the Buddha; the narrative assigning a specific occasion and interlocutor belongs to the later commentary and is not used as evidence here. |
