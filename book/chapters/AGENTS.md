...
- Chapter 99 owns the reader-facing source map. Keep each external link's K, P, V, or R code in its visible label so the destination remains distinguishable in an assistive-technology link list.
