...
```mermaid
flowchart LR
  A["Seven-day start"] --> M["Days 8–30 bridge"] --> B["Foundations"] --> C["Dependent origination"] --> D["Technique"] --> E["Integration"] --> F["Safety"] --> G["First three fetters"] --> H["Five lower fetters and four fruits"] --> I["Insight map as later reference"]
```
