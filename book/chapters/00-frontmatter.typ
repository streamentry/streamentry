...
#practice-card(
  ...
  [
    + Ấn bản ghi công *#(edition.metadata.author)*. *CS Chánh Niệm* là tên công bố; hồ sơ hiện không xác lập hai chữ *CS* là học vị, chức danh hay sự chuẩn nhận tôn giáo, và chưa công bố tiểu sử, bằng cấp hay sự chuẩn nhận giảng dạy có thể kiểm chứng độc lập.
    ...
    + Tại ngày chốt ấn bản, chưa có quyết định quyền tái phân phối đủ thẩm quyền, phản biện Theravāda độc lập, phản biện an toàn lâm sàng, nhóm thử nghiệm năm người mới hoặc thử EPUB bằng người thật cho đúng cặp tệp của ấn bản này. EPUB là sách điện tử tự dàn theo màn hình. Vì vậy, đây là ứng viên đã kiểm định nội bộ, chưa phải ấn bản được xác nhận độc lập hay “lựa chọn số một”.
