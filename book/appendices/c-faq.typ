...
#faq-card(
  ...
  [
    ...
    #v(5pt)
    R01 ghi nhận các trải nghiệm khó khăn trong những bối cảnh thiền; R02 tổng hợp biến cố bất lợi với ước lượng khác nhau theo nghiên cứu. Các nguồn này không xác định nguyên nhân của một trường hợp cá nhân.

    #source-badge("BIÊN SOẠN", refs: [đối chiếu R05; Chương 9])
    #v(5pt)
    Không nên coi mọi bất ổn là một tầng tuệ phải đi xuyên qua.

    Khi dấu hiệu mạnh, kéo dài, tăng lên hoặc làm suy giảm sinh hoạt, hãy dừng buổi hiện tại, không tiếp tục thực hành cường độ cao và tìm hỗ trợ y tế phù hợp theo #link(<muc-vang>)[mức vàng ở Chương 9]. Không cần chờ buổi gặp người hướng dẫn mới tìm chăm sóc y tế. R05 hỗ trợ việc liên hệ người chăm sóc sức khỏe khi dấu hiệu tăng hoặc không hết; hướng dẫn dừng thiền là phần biên soạn. Nguy cơ tức thời cần #link(<muc-do>)[trợ giúp khẩn cấp], không đợi xác định đó là tuệ hay bệnh.
  ],
)
