...
#practice-card(
  ...
  [
    ...
    Nếu triệu chứng mạnh, kéo dài hoặc làm xấu đời sống, hãy giảm hay dừng thực hành, báo cho người hướng dẫn và tìm chuyên gia y tế phù hợp.
...
#practice-card(
  ...
  [
    Có thể đem sự biết rõ vào đi, đứng, co duỗi, ăn uống và các hoạt động thường ngày như K01 mô tả. Tuy vậy, biết một động tác không thay thế bổn phận, giới hay sự chú ý cần thiết cho công việc nguy hiểm. Khi lái xe hoặc vận hành máy, ưu tiên an toàn và nhận biết toàn cảnh.
